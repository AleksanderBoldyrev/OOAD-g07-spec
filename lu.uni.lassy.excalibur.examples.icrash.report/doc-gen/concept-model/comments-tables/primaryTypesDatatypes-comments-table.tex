...
\adddoublerow{dtCapcha}{ a capcha used to authentify an user}
...
\adddoublerow{etCoordinatorType}{enum type for choosing a type of Coordinator - Coordinator of a Hospital}
\adddoubletwocolumnrow{operation}{\msrcode{is():ptBoolean}}{}
