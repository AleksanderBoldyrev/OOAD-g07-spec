...
\adddoubletwocolumnrow{attribute}{\msrcode{capcha: dtCapcha}}{used to identify user.}
...
\adddoubletwocolumnrow{operation}{\msrcode{init(Acapcha:dtCapcha, Alogin:dtLogin, Apwd:dtPassword):ptBoolean}}{used to initialize the current object as a new instance of the ctAuthenticated type.}
...
\adddoubletwocolumnrow{attribute}{\msrcode{type: etCoordinatorType}}{a type of Coordinator. Hospitals have fewer available methods}
\adddoubletwocolumnrow{operation}{\msrcode{init(Aet:etCoordinatorType, Aid:dtCoordinatorID, Alogin:dtLogin, Apwd:dtPassword):ptBoolean}}{used to initialize the current object as a new instance of the ctCoordinator type.}
